<?php
    ...
    if(isset($_POST['sbm'])){
        ...
        $sql_add = "INSERT INTO product(cat_id, prd_name, prd_image, prd_price, prd_warranty, 
        prd_accessories, prd_new, prd_promotion, prd_status, prd_featured, prd_details)
        VALUES('$cat_id', '$prd_name', '$prd_image', '$prd_price', '$prd_warranty', '$prd_accessories', 
               '$prd_new', '$prd_promotion', '$prd_status', '$prd_status', '$prd_details')";
        $query_add = mysqli_query($conn, $sql_add);
        move_uploaded_file($prd_image_tmp_name, 'img/img_prd/'.$prd_image);       
