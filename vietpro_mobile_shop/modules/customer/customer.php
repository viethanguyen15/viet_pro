<?php
    require 'PHPMailer_send/PHPMailer/src/Exception.php';
    require 'PHPMailer_send/PHPMailer/src/PHPMailer.php';
    require 'PHPMailer_send/PHPMailer/src/SMTP.php';
    ...
    if(isset($_POST['name']) && isset($_POST['phone']) && isset($_POST['email']) && isset($_POST['add'])){
        ...
        try {
            ...
            $mail->Username   = 'viethanguyen510@gmail.com';                     // SMTP username
            $mail->Password   = 'jmtpztufbbxxzktp';                               // SMTP password
            $mail->SMTPSecure = 'TLS';         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` also accepted
            $mail->Port       = 587;                                    // TCP port to connect to
        
            //Recipients
            $mail->setFrom('viethanguyen510@gmail.com', 'VietproShop');
            $mail->addAddress($email, 'khach hang');     // Add a recipient
            // $mail->addAddress('ellen@example.com');               // Name is optional
            // $mail->addReplyTo('info@example.com', 'Information');
            $mail->addCC('viethanguyen510@gmail.com');
